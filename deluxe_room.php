...
<div id="container">
    ...
    <main>
    	<div class="centre">
        	...
        	<div id="slideshow">
                <div class="slider">
                    <div class="item"><img alt="" src="system/images/gallery/1.jpg" width="1200" height="600" /></div>
                    <div class="item"><img alt="" src="system/images/gallery/2.jpg" width="1200" height="600" /></div>
                    <div class="item"><img alt="" src="system/images/gallery/4.jpg" width="1200" height="600" /></div>
                    <div class="item"><img alt="" src="system/images/gallery/7.jpg" width="1200" height="600" /></div>
                    <div class="item"><img alt="" src="system/images/gallery/5.jpg" width="1200" height="600" /></div>
                    <div class="item"><img alt="" src="system/images/gallery/11.jpg" width="1200" height="600" /></div>
                    <div class="item"><img alt="" src="system/images/gallery/14.jpg" width="1200" height="600" /></div>
                    <div class="item"><img alt="" src="system/images/gallery/15.jpg" width="1200" height="600" /></div>
                </div>
                <div class="nav">
        	...
        	<div id="left">
                <div id="content">
                    <h2><strong>Deluxe</strong> Room</h2>
                    <p style="text-align: left">Situated on the main road of Ao Phanang (Aonang). The Airy Aonang is an ideal base for visitor who wish to relax and enjoy their holiday in quite  surrounding and within walking distance to the beach, shopping and enterainment offer at Aonang.</p>
                    
					<p style="text-align: left"> 
						<h3 style="text-align: left">Terms and Conditions:</h3>
						<ul style="text-align: left; padding-left: 20px !important">
							<li>Rates are nett based on per room per night inclusive of tax & Service charge</li>
							<li>Rates are Including American Breakfast in room rate based on room type configuration</li>
							<li>Rate are for individual reservation only and subject to space availability at time of reservation</li>
							<li>Child age under 4 years old sharing existing with parents room and bedding is complimentary stay</li>
							<li>Child age from 4-11 years old with an additional charge for breakfast or extra bed charge</li>
							<li>Check in time : 14.00 hrs.</li>
							<li>Check out time : 12.00 hrs.</li>
							<li>A security deposit of THB 500 is required upon check-in for charges or damages during the stay and will be refunded upon departure.</li>
						</ul>
					</p>
					...
					<p style="text-align: left"> 
						...
						<ul style="text-align: left; padding-left: 20px !important">						
							<li>Any cancellation within 14 days in a high & Peak season / 7 days during the low season.</li>
							<li>No show & Non arrival with full amount charge</li>
						</ul>
					</p>
					...
					<p style="text-align: left"> 
						...
						<ul style="text-align: left; padding-left: 20px !important">
							...
							<li>by credit card with signature on form send by hotel reservation</li>
						</ul>
					</p>
                   ...
                   <p style="text-align: left"> 
						...
						<ul class="tags">       
							...
							<li>WirelessInternet (Wifi)</li> 
							<li>TV</li>
							<li>Welcome beverage set</li>
						</ul>
					</p>
            ...
            <aside class="layout2">
            	<div id="scroll">
                    <div id="block">
                        <div class="blocktitle"><a href="contact.php"><span>Book Now</span></a></div>
