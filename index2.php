...
<header>
    ...
    <div id="featured">
        <div class="slider">        	
        	<div class="item" style="background-image:url(system/images/slide/1.jpg);">
                <div class="details">
                    <div class="title"><span>The Airy Aonang</span></div>
                    <div class="buttoncontainer"><a href="#" class="button"><span data-hover="Explore The Hotel">Serviced Apartment | Contemporary Style</span></a></div>
                </div>
            </div>
            <div class="item" style="background-image:url(system/images/slide/2.jpg);">
                <div class="details">
                    <div class="title"><span>The Airy Aonang</span></div>
                    <div class="buttoncontainer"><a href="#" class="button"><span data-hover="Explore The Hotel">Serviced Apartment | Contemporary Style</span></a></div>
                </div>
            </div>
             <div class="item" style="background-image:url(system/images/slide/5.jpg);">
                <div class="details">
                    <div class="title"><span>The Airy Aonang</span></div>
                    <div class="buttoncontainer"><a href="#" class="button"><span data-hover="Explore The Hotel">Serviced Apartment | Contemporary Style</span></a></div>
                </div>
            </div>
            <div class="item" style="background-image:url(system/images/slide/6.jpg);">
                <div class="details">
                    <div class="title"><span>The Airy Aonang</span></div>
                    <div class="buttoncontainer"><a href="#" class="button"><span data-hover="Explore The Hotel">Serviced Apartment | Contemporary Style</span></a></div>
                </div>
            </div>        
              <div class="item" style="background-image:url(system/images/slide/4.jpg);">
                <div class="details">
                    <div class="title"><span>The Airy Aonang</span></div>
                    <div class="buttoncontainer"><a href="#" class="button"><span data-hover="Explore The Hotel">Serviced Apartment | Contemporary Style</span></a></div>
                </div>
    	...
    	<div class="centre">
           ...
           <!-- List Items (Rooms) | START -->
            <section id="rooms" class="list grid">
                <div class="item">
                	<div class="container">
                        <div class="imgcontainer"><img alt="" src="system/images/room/1.jpg" width="380" height="380" /></div>
                        <div class="details">
                            <a href="accom_detail1.php">
                ...
                <div class="item">
                	<div class="container">
                        <div class="imgcontainer"><img alt="" src="system/images/room/4.jpg" width="380" height="380" /></div>
                        <div class="details">
                            <a href="accom_detail2.php">
                                <h3 class="title">Triple Room<br />
                                <span>The Airy Aonang</span></h3>
                                <p>The apartments at The Airy Aonang are air-conditioned and offer a private bathroom, wireless internet access and a refrigerator. They are also fitted with a shower and cable/satellite channels.</p>
                                <div class="button"><span data-hover="View Room">View Room</span></div>
                            </a>
