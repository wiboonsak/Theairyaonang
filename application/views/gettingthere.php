...
<meta name="GENERATOR" content="Bootstrap,Javascript,PHP,CSS,Editplus">
...
<div id="container">
	<header>
    	<div id="header">
        	<div class="h1">
                <h1><span>Facilities & Services</span>
    ...
    <main>
    	<div class="centre">
            <h1>Getting There <strong>The Airy Aonang</strong></h1>
           ...
           <div class="row">
				<div class="col-md-6">
					<p><h3 style="text-align: left">Distance:</h3>
						<ul style="text-align: left; padding-left: 25px;">
							<li>To Ao Nang Beach 500m.</li>
							<li>To Railay Beach by longtail Boat 15 minutes from Aonang Beach</li>
							<li>To Krabi Town 10 Km.</li>
							<li>To Krabi Airport 25 Km.</li>
						</ul>
					</p>
				</div>
				<div class="col-md-6">
					<p><h3 style="text-align: left">Transportation (Van and Taxi):</h3>
					<ul style="text-align: left; padding-left: 25px;">
						<li>Krabi Town</li>
						<li>Krabi Airport</li>
						<li>Phuket Airport</li>
						<li>Suratthani Airport</li>
						<li>Trang Airport</li>
						<li>Hatyai Airport</li
					</ul>
					</p>      
				</div>
		  	</div>
