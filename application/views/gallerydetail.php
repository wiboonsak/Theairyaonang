...
<html>
    <head>
        ...
        <title>themelot.net - Base Hotel - Photo Gallery</title>
    ...
    <body>
        ...
        <div id="container">
            ...
            <header>
                <div id="header">
                    <div class="h1">
                        <h1><span><?php echo $galleryName ?></span>
                ...
                <div id="gallery">
                    ...
                    foreach ($imagesList->result() AS $img) {
                        ...
                        <!-- Feature --><figure class="<?php echo $c; ?>">
                            <a href="<?php echo base_url('images/gallery/1.jpg') ?>">
                                <span><h3><?php echo $galleryName ?></h3></span>
                                <img alt="" data-original="<?php echo base_url('uploadfile/gallery/') . $img->image_name ?>" width="900" height="600" src="<?php echo base_url('images/blank.png') ?>" />
                            </a>
                        </figure>
 <?php $n++;$c = '';} ?>
                </div>
