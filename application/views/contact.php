...
if($continue===true){
	...
	$mail->Subject = 'Booking Request from '.iconv('TIS-620', 'UTF-8', $_POST['contact-name']);
	$mail->MsgHTML($message);
	if (!$mail->send()) {
...
<div id="container">
    ...
    <main>
    	<div class="centre">
            <!-- Contact Form | START -->
        	<div id="contact">
            	<img src="<?php echo base_url('images/contact.jpg')?>" width="1200" height="400" alt="" />
                <?=$alert;?>
            ...
            <!-- Contact Form | END -->
            <h2 style="margin:0;"><strong>+66 (0) 75 817 644, +66 (0) 95 039 7644</strong></h2>
            <p style="margin:0;"><a href="mailto:rsvn@theairyaonang.com">rsvn@theairyaonang.com</a><br />
            110 M.2 Aonang Beach, Ao Nang, Krabi, Thailand 81180.<br />
