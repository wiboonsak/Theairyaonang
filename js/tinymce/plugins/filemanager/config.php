...
$base_url='http://www.cashewnutcovelipe.com'; //url base of site if you want only relative url leave empty $upload_dirConfig  $base_urlConfig
$upload_dir = '/source_img/'; // path from base_url to upload base dir
$current_path = '../../../../source_img/'; // relative path from filemanager folder to upload files folder
$current_path="../../../../../source_img/";
